...
export const streaming: Record<string, string> = {
  ...
  soundcloud: '', // NOT Nick's account — do not link until ownership is confirmed by Nick
...
export const releases: Release[] = [
  {
    ...
    tracks: [
      ...
      'Heavy Darling',
      'Wretched Rings And Pretty Things',
      'The Witches Broom',
      'Will We Never?',
      'I Want You, I Need You, I Love You',
      "I'll Leave A Light On",
      'Her Sights Were Well',
      "You're My Woman",
  ...
  },
  {
    ...
    tracks: [
      ...
      'New Moon Enchantress',
      'Gloomy Gallow',
      "Get So High That I Can't Come Down",
      'It Sees No End Goddess',
      'Get Up Off The Ground',
      "Don't Waste Your Time On All That Jive",
      'Pig-Me The Boar',
      'Go With The Flow',
      'Join The Experience',
      "You're My God",
  ...
  },
  {
    ...
    tracks: [
      'We Will Not Follow',
      'The Nite Time Is The Rite Time',
      'Pigs In Zen',
      'The Moon Is Full',
      'Whore Am I',
      'The Mona Lisa',
  ...
  },
  {
    ...
    type: 'Album',
    year: '2022',
    artwork: '/images/releases/are-you-mental-2.jpg',
    trackCount: 12,
    tracks: [
  ...
  },
  {
    ...
    type: 'Album',
    year: '2022',
    artwork: '/images/releases/are-you-mental-1.jpg',
    trackCount: 12,
    tracks: [
      'Mary Do You Wanna?',
      'The Butterfly T',
...
//
//  TRUE since 2026-07-31 — Stripe is LIVE. The price IDs below are live-mode
//  prices on Nick's verified account. Real cards, real money, real payouts.
//
export const storeEnabled = true;
...
export const products: Product[] = [
  ...
  // --- MUSIC STORE (digital) ----------------------------------------------
  {
    ...
    // Newest release — priced higher than the back catalogue.
    // Confirmed by Nick 2026-07-31: $14.99 for this one, $9.99 for the rest.
    priceCents: 1499,
    description: 'Full album download. High quality files, yours to keep.',
    image: '/images/releases/thrilla-killa.jpg',
    kind: 'digital',
    stripePriceId: 'price_1TzSKsQ0jYrsWdaSc36SCuzb', // filled in during Stripe setup
    available: true,
  },
  {
    ...
    kind: 'digital',
    stripePriceId: 'price_1TzSKsQ0jYrsWdaSxQo1uVnd', // filled in during Stripe setup
    available: true,
  },
  {
    ...
    kind: 'digital',
    stripePriceId: 'price_1TzSKtQ0jYrsWdaS86EwYv3k', // filled in during Stripe setup
    available: true,
  },
  {
    id: 'album-daze',
    ...
    kind: 'digital',
    stripePriceId: 'price_1TzSKtQ0jYrsWdaSMbBlIqZ8', // filled in during Stripe setup
    available: true,
  },
  {
  ...
  },
  {
    ...
    kind: 'digital',
    stripePriceId: 'price_1TzSKuQ0jYrsWdaStvY5rbAl', // filled in during Stripe setup
    available: true,
  },
  {
    ...
    kind: 'digital',
    stripePriceId: 'price_1TzSKvQ0jYrsWdaSCZGRxuZV', // filled in during Stripe setup
    available: true,
  },
  {
    ...
    image: '/images/releases/merely-lives.jpg',
    kind: 'digital',
    stripePriceId: 'price_1TzSKvQ0jYrsWdaSs0tRwFQy', // filled in during Stripe setup
    available: true,
  },
  {
    id: 'album-dig-this',
  ...
  },
  {
    ...
    kind: 'digital',
    stripePriceId: 'price_1TzSKwQ0jYrsWdaSkGQRNoCm', // filled in during Stripe setup
    available: true,
  },
];
