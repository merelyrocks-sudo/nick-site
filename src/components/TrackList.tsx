          ...
          return (
            <li key={i} className="relative border-b border-line">
              ...
              {isPlaying && (
                <div
                  aria-hidden="true"
                  className="absolute inset-y-0 left-0 bg-bone/10 transition-[width] duration-200"
              ...
              <button
                ...
                className="relative flex w-full items-center gap-5 px-1 py-4 text-left transition-colors hover:bg-bone/5 disabled:cursor-default disabled:hover:bg-transparent"
              >
                ...
                <span className="shrink-0" aria-hidden="true">
                  {src ? (
                    isPlaying ? (
                      // Pause glyph
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="currentColor" className="text-bone">
                ...
                <span
                  className={`flex-1 text-base ${
                    isPlaying ? 'text-bone' : named ? 'text-bone-dim' : 'text-bone-faint'
                  }`}
                >
                  {title}
                </span>
